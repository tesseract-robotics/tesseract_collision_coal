...
inline void runTestTyped(DiscreteContactManager& checker, ContactTestType test_type)
{
  ...
  location[tesseract::common::LinkId::fromName("box_link")].translation()(0) = 0.2;
  location[tesseract::common::LinkId::fromName("box_link")].translation()(1) = 0.1;
  location[tesseract::common::LinkId::fromName("second_box_link")] = Eigen::Isometry3d::Identity();
  ...
  ////////////////////////////////////////////////
  {
    // location[tesseract::common::LinkId::fromName("box_link")].translation() = Eigen::Vector3d(1.60, 0, 0);
    location[tesseract::common::LinkId::fromName("box_link")].translation() = Eigen::Vector3d(1.60 + 1e-10, 0, 0);
    result.clear();
    result_vector.clear();

    // Use different method for setting transforms
    std::vector<std::string> names = { "box_link" };
    tesseract::common::VectorIsometry3d transforms = { location[tesseract::common::LinkId::fromName("box_link")] };
