...
inline void runTest(DiscreteContactManager& checker)
{
  ...
  location[tesseract::common::LinkId("cylinder_link")] = Eigen::Isometry3d::Identity();
  location[tesseract::common::LinkId("cylinder_link")].translation()(0) = 0.2;
  ...
  ////////////////////////////////////////////////
  location[tesseract::common::LinkId("cylinder_link")].translation() = Eigen::Vector3d(1, 0, 0);
  result.clear();
  result_vector.clear();

  // Use different method for setting transforms
  std::vector<std::string> names = { "cylinder_link" };
  tesseract::common::VectorIsometry3d transforms = { location[tesseract::common::LinkId("cylinder_link")] };
