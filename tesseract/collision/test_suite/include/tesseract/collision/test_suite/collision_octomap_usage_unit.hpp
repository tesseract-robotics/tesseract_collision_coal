                                                         ...
                                                         tesseract::geometry::OctreeSubType subtype)
{
  ...
  map_far[tesseract::common::LinkId::fromName("octomap_link")] = far_pose;
                                                           ...
                                                           tesseract::geometry::OctreeSubType subtype)
{
  ...
  static_map_far[tesseract::common::LinkId::fromName("octomap2_link")] = static_far;
  ...
  map_start[tesseract::common::LinkId::fromName("octomap1_link")] = start;
  map_end[tesseract::common::LinkId::fromName("octomap1_link")] = end;
