...
{
  auto bt_simple_checker = std::make_shared<tesseract::collision::BulletDiscreteSimpleManager>();
  auto bt_bvh_checker = std::make_shared<tesseract::collision::BulletDiscreteBVHManager>();
  auto fcl_bvh_checker = std::make_shared<tesseract::collision::FCLDiscreteBVHManager>();
...
{
  auto bt_simple_checker = std::make_shared<tesseract::collision::BulletCastSimpleManager>();
  auto bt_bvh_checker = std::make_shared<tesseract::collision::BulletCastBVHManager>();
