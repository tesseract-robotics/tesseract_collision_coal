...
void CoalCollisionObjectWrapper::setSourceShapeIndex(int index) { source_shape_index_ = index; }

int CoalCollisionObjectWrapper::getSourceShapeIndex() const
{
  if (source_shape_index_ >= 0)
    return source_shape_index_;
